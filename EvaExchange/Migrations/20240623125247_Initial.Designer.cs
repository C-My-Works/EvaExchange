...
namespace EvaExchange.Migrations
{
    ...
    [Migration("20240623125247_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EvaExchange.Entities.Share", b =>
                {
                    ...
                    b.Property<DateTime>("PriceChangeDate")
                        ...
                        .HasDefaultValue(new DateTime(2024, 6, 23, 12, 52, 47, 312, DateTimeKind.Utc).AddTicks(2173));
            ...
            modelBuilder.Entity("EvaExchange.Entities.Trade", b =>
                {
                    ...
                    b.Property<DateTime>("TradeTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2024, 6, 23, 12, 52, 47, 312, DateTimeKind.Utc).AddTicks(2589));
            ...
            modelBuilder.Entity("EvaExchange.Entities.Share", b =>
                {
                    b.HasOne("EvaExchange.Entities.Portfolio", null)
                        .WithMany("Shares")
